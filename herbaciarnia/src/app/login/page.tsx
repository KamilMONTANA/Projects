...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Atrapa logowania - symulacja opóźnienia
    await new Promise(resolve => setTimeout(resolve, 1000));
    
    setIsSubmitting(false);
    
    // Atrapa - zawsze "loguje" pomyślnie
    router.push('/profile');
  };
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-emerald-500">Lub kontynuuj z</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full inline-flex justify-center py-2 px-4 border border-emerald-200 rounded-md shadow-sm bg-white text-sm font-medium text-emerald-700 hover:bg-emerald-50">
                <span className="sr-only">Zaloguj się przez Google</span>
              ...
              <button className="w-full inline-flex justify-center py-2 px-4 border border-emerald-200 rounded-md shadow-sm bg-white text-sm font-medium text-emerald-700 hover:bg-emerald-50">
                <span className="sr-only">Zaloguj się przez Facebook</span>
